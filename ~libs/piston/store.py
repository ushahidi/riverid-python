...
class DataStore(oauth.OAuthDataStore):
    ...
    def lookup_nonce(self, oauth_consumer, oauth_token, nonce):
        ...
        #m
        try:        
            nonce = Nonce.objects.get(key=nonce)
            return nonce.key
            
        except:
            Nonce.objects.get_or_create(consumer_key=oauth_consumer.key, 
    ...
    def fetch_access_token(self, oauth_consumer, oauth_token, oauth_verifier):
        print oauth_consumer.key, '==', self.consumer.key
        print oauth_token.key, '==', self.request_token.key 
        print oauth_verifier, '==', self.request_token.verifier
        print self.request_token.is_approved
